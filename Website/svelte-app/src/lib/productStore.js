...
export const products = [
    { id: 1, name: "I survived T-Shirt", price: "$2900.99", image: `${base}/images/clothing/shirts/fluid.png`, image2: `${base}/images/clothing/shirts/fluid.png`, image3: `${base}/images/clothing/shirts/fluid.png`, 
    ...
    { id: 2, name: "Havel T-Shirt", price: "1989,- CZK", image: `${base}/images/clothing/shirts/havel.png`, image2: `${base}/images/clothing/shirts/havel.png`, image3: `${base}/images/clothing/shirts/havel.png`,
    ...
    { id: 3, name: "Split Cargo Sweatpants", price: "$34.99", image: `${base}/images/clothing/pants/black_and_white.png`,
    ...
    { id: 4, name: "Trusty Boots", price: "$27.99", image: `${base}/images/clothing/boots/trusty.png`,
    ...
    { id: 5, name: "Platform Boots", price: "$32.99", image: `${base}/images/clothing/boots/tall.png`,
    ...
    { id: 6, name: "Daily Boots", price: "$29.99", image: `${base}/images/clothing/boots/daily.png`,
    ...
    { id: 7, name: "Cat Stare Hoodies", price: "$32.99", image: `${base}/images/clothing/hoodies/cat_stare.png`,
    ...
    { id: 8, name: "Swept Sweater", price: "$32.99", image: `${base}/images/clothing/sweaters/swept.png`,
    ...
    { id: 9, name: "Bug Sweater", price: "$27.99", image: `${base}/images/clothing/sweaters/bug.png`,
    ...
    { id: 10, name: "Hearts Totebag", price: "$32.99", image: `${base}/images/clothing/accessories/hearts.png`,
    ...
    { id: 11, name: "Pavlik Pants", price: "$29.99", image: `${base}/images/clothing/pants/pavlik.png`,
    ...
    { id: 12, name: "I <3 Kapr hoodie", price: "$32.99", image: `${base}/images/clothing/hoodies/Hoodie_mockup_front.png`, image2: `${base}/images/clothing/hoodies/Hoodie_mockup_back.png`,
    ...
    { id: 13, name: "Artist Hat", price: "$32.99", image: `${base}/images/clothing/accessories/artist-hat.png`, image2: `${base}/images/clothing/accessories/artist-hat.png`,
      originalPrice: "$42.99", rating: 4.4, reviewCount: 71,
      description: "Another vintage option with unique styling elements.",
      features: [
        "Classic vintage look",
    ...
    { id: 14, name: "Kapr Pin", price: "$32.99", image: `${base}/images/clothing/accessories/kapr-pin.png`, image2: `${base}/images/clothing/accessories/kapr-pin.png`,
      originalPrice: "$42.99", rating: 4.4, reviewCount: 71,
      description: "Another vintage option with unique styling elements.",
      features: [
        "Classic vintage look",
    ...
    { id: 15, name: "Pivo Socks", price: "$32.99", image: `${base}/images/clothing/accessories/pivo.png`, image2: `${base}/images/clothing/accessories/pivo.png`,
      originalPrice: "$42.99", rating: 4.4, reviewCount: 71,
      description: "Another vintage option with unique styling elements.",
      features: [
        "Classic vintage look",
